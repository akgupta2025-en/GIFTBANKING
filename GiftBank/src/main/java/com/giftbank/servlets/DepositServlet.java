...
public class DepositServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        response.sendRedirect("jsp/deposit.jsp");
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            transPst.setString(2, "DEPOSIT");
            transPst.setBigDecimal(3, depositAmount);
            transPst.setBigDecimal(4, newBalance);
            transPst.setString(5, "Cash deposit - Amount: " + amount);
            transPst.executeUpdate();

            con.commit();
            con.setAutoCommit(true);

            request.setAttribute("success", "Amount deposited successfully! New Balance: " + newBalance);
