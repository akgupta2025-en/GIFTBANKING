...
<head>
    ...
    <title>GIFT Bank - Deposit Money</title>
    ...
    <div class="d-flex">
        ...
        <nav class="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="deposit.jsp"><i class="bi bi-arrow-up-circle"></i> Deposit</a>
                </li>
                <li class="nav-item">
        ...
        <div class="main-content">
            ...
            <div class="container-fluid p-4">
                <div class="row mb-4">
                    <div class="col-md-12">
                        <h1 class="h3 mb-2"><i class="bi bi-arrow-up-circle"></i> Deposit Money</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card bg-light">
                            <div class="card-body">
                                <h5 class="card-title mb-3"><i class="bi bi-question-circle"></i> Deposit Information</h5>
                                <ul class="list-unstyled">
                                    <li class="mb-2">
                                        <strong>What is a deposit?</strong><br>
                                        <span class="text-muted">A deposit is transferring money into your bank account</span>
                                    </li>
                                    <li class="mb-2">
                                        <strong>Is there a minimum deposit amount?</strong><br>
                                        <span class="text-muted">Any amount above ₹1 can be deposited</span>
                                    </li>
                                    <li class="mb-2">
                                        <strong>How long does it take?</strong><br>
                                        <span class="text-muted">Deposits are processed instantly in our system</span>
                                    </li>
                                    <li class="mb-2">
                                        <strong>Are deposits secure?</strong><br>
                                        <span class="text-muted">Yes, all transactions are secure and encrypted</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card mt-3 border-success">
                            <div class="card-body">
                                <h6 class="card-title text-success">Transaction Successful!</h6>
